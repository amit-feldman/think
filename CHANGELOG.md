...
### Fixed
- README examples updated to plain-text labels (no bold) and clarified 'Spawn as' wording
- CLI `think context` now displays the correct default token budget from configuration

## [0.5.6] - 2026-02-09

### Fixed
- Removed bold markdown labels and self-referential tool naming from project context output
